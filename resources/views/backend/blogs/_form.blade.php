<div class="w-full  bg-gray-50 px-12 py-12">
    <input type="text" placeholder="Write your title" name="title" value="" class="my-3 w-full border-gray-300" />
    @error('title')
        <div class="text-red-600">{{ $message }}</div>
    @enderror
    <textarea name="dis" placeholder="Discription" class="w-full border-gray-300"></textarea>
    @error('dis')
        <div class="text-red-600">{{ $message }}</div>
    @enderror
